 ...
 */
	public String getName() {
		return objName; // Replace with your code
	}
 ...
 */
	public String getDescription() {
		return objDescription; // Replace with your code
	}
 ...
 */
	public int getInitialLocation() {
		return initialLocation; // Replace with your code
	}
	...
	public static AdvObject readFromFile(Scanner scan) {
		...
		if (scan.hasNext()){
			...
			if (line.length() == 0 ){
				...
				line = scan.nextLine();
				obj.objDescription = line;
				
				line = scan.nextLine();
				obj.initialLocation = Integer.parseInt(line);
